...
class Environment(object):
    ...
    def reset(self, testing=False):
        ...
        start = list(random.choice(self.intersections.keys()))
        destination = list(random.choice(self.intersections.keys()))
        ...
        start_heading = list(random.choice(self.valid_headings))
        ...
        for agent in self.agent_states.iterkeys():
            ...
            # intersections and headings still in 'positions'
                ...
                intersection = list(random.choice(positions.keys()))
                heading = list(random.choice(positions[intersection]))
                self.agent_states[agent] = {
...
class DummyAgent(Agent):
    ...
    def __init__(self, env):
        ...
        self.next_waypoint = list(random.choice(Environment.valid_actions[1:]))
        self.color = list(random.choice(self.color_choices))
