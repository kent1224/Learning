    ...
    def updateDistributions(self, distributions):
        ...
        for x in range(len(self.distributionImages)):
            for y in range(len(self.distributionImages[0])):
                ...
                #print(weights,colors)
                for weight, gcolor in list(zip(weights, colors)):
                    #print(list(zip(color, gcolor)))
                    #print (weight, list(gcolor))
                    color = [min(1.0, c + 0.95 * g * weight ** .3) for c,g in list(zip(color, list(gcolor)))]
                    #print(list(zip(color, gcolor)))
                    #print(c,g)
                    #print(color,list(gcolor))
                #print(*color)
